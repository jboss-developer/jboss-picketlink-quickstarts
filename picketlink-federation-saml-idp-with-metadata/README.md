picketlink-federation-saml-idp-with-metadata: PicketLink Identity Provider With a Basic Configuration
===============================
Author: Pedro Igor  
Level: Intermediate  
...
It demonstrates how to configure an web application as an Identity Provider with Encryption, Digital Signature in SAML Assertions and using the SAML Metadata Support.
...
4. This will deploy `target/picketlink-federation-saml-idp-with-metadata.war` to the running instance of the server.


Access the application
---------------------

The application will be running at the following URL: <http://localhost:8080/idp-metadata>.
