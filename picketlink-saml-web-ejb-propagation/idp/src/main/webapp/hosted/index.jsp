...
<img src="images/picketlink-banner-1180px.png"
    ...
    <p>
        If you hit this page you're probably ready to get started using PicketLink Federation.
    </p>
    <p>
        Make sure you have deployed some of the Service Providers provided by the PicketLink Quickstarts
        to check if they are in the same Circle of Trust of this IDP.
    </p>
</body>
</html>