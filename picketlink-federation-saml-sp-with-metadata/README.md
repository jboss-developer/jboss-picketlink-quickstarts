...
4. This will deploy `target/picketlink-federation-saml-sp-with-metadata.war` to the running instance of the server.


Access the application
---------------------

The application will be running at the following URL: <http://localhost:8080/sales-metadata>.
