...
<img src="<%= request.getContextPath() %>/images/picketlink-banner-1180px.png"
    ...
    <p>
        <ul>
            <li>SAML 2 Unsolicited Response: <a id="saml_2_sales_link" href="?SAML_VERSION=2.0&TARGET=http%3A//localhost%3a8080/sales-post-sig/">Sales SAML 2.0</a> (<i>make sure you have deployed the sales-post-sig application</i>)</li>
        </ul>
    </p>
</div>
</body>
