picketlink-federation-saml-idp-with-signature: PicketLink Identity Provider With Signature
===============================
Author: Pedro Igor
Level: Intermediate
...
The application will be running at the following URL: <http://localhost:8080/idp-sig>.
